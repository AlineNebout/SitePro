      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { label: "Gérer les praticiens", href: "/admin/praticiens" },
            ...
            >
              {link.label}
              <svg className="w-4 h-4 text-text-muted group-hover:text-primary" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" aria-hidden="true">
